...
class _TranslationScreenState extends State<TranslationScreen> {
  ...
  void initState() {
    super.initState();
    translationScreenController.adsHelper.loadBannerAd();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        customIconButton(
                          () {
                            String temp = Get.find<HomeScreenController>()
                                .dropDownValue1
                                .value;
                            Get.find<HomeScreenController>()
                                    .dropDownValue1
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Obx(() {
                              String currentText = translationScreenController
                                  .textEditingController.text;
                            ...
                            Padding(
                              ...
                              child: IconButton(
                                onPressed: () async {
                                  if (!translationScreenController
                                      .isConnected.value) {
                  ...
                  children: [
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          Obx(() {
                            String translatedText = translationScreenController
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          onPressed: () {
                            translationScreenController.speak(
                                translationScreenController
                                    .translatedText.value,
                                Get.find<HomeScreenController>()
                                    .dropDownValue2
      ...
      bottomNavigationBar: Obx(() {
        bool adLoaded =
            translationScreenController.adsHelper.isBannerAdLoaded.value &&
                translationScreenController.adsHelper.bannerAd != null &&
        ...
        return adLoaded
            ? Container(
                ...
                child: SizedBox(
                  width: Get.width,
                  height: translationScreenController
                      .adsHelper.bannerAd!.size.height
                      .toDouble(),
                  child: AdWidget(
                      ad: translationScreenController.adsHelper.bannerAd!),
                ),
              )
            : Shimmer.fromColors(
